...
def convert_to_json(obj, pretty_indent=4):
    ...
    Anyway this is here, so I could plug in a fake API response and watch the LoggingLogger do the
    logging without hitting the openai API and waiting for a response, etc.
    """
